...
def test_macro_f1_is_lower_than_accuracy_when_a_class_collapses():
    ...
    # (1 + 1 + 2/3 + 0) / 4
    assert macro_f1(GOLD, PRED) == pytest.approx(2 / 3)
